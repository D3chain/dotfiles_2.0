...
-- hl.bind("CTRL + ALT + DELETE", hl.dsp.exec_cmd("my-omarchy-hyprland-window-close-all"), { description = "Close all windows" })

hl.bind("SUPER + CTRL + J", hl.dsp.layout("togglesplit"), { description = "Toggle window split" })
...
--hl.bind("SUPER + O", hl.dsp.exec_cmd("my-omarchy-hyprland-window-pop"), { description = "Pop window out (float & pin)" })
--hl.bind("SUPER + L", hl.dsp.exec_cmd("my-omarchy-hyprland-workspace-layout-toggle"), { description = "Toggle workspace layout" })
...
hl.bind("SUPER + ALT + H", hl.dsp.window.move({ into_group = "l" }), { description = "Move window to group on left" })
hl.bind("SUPER + ALT + L", hl.dsp.window.move({ into_group = "r" }), { description = "Move window to group on right" })
hl.bind("SUPER + ALT + K", hl.dsp.window.move({ into_group = "u" }), { description = "Move window to group on top" })
hl.bind("SUPER + ALT + J", hl.dsp.window.move({ into_group = "d" }), { description = "Move window to group on bottom" })
...
hl.bind("SUPER + CTRL + H", hl.dsp.group.prev(), { description = "Move grouped window focus left" })
hl.bind("SUPER + CTRL + L", hl.dsp.group.next(), { description = "Move grouped window focus right" })
...
--hl.bind("SUPER + code:61", hl.dsp.exec_cmd("my-omarchy-hyprland-monitor-scaling-cycle"), { description = "Cycle monitor scaling" })
--hl.bind("SUPER + ALT + code:61", hl.dsp.exec_cmd("my-omarchy-hyprland-monitor-scaling-cycle --reverse"), { description = "Cycle monitor scaling backwards" })
